...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (width >= 700) setIsBurger(false);
  ...
  return (
    <div className="bg-black w-full flex flex-col items-center text-white ">
      ...
      <AnimatePresence>
        {isBurger && (
          <motion.nav
            ...
            style={glassmorphism}
            className="fixed top-[85px] h-[50px] border-y-[0.5px] border-shades-200 hidden homesm:block"
          >
      ...
      <main className="flex flex-col items-center">
        ...
        {/* features */}
        <section className="flex flex-col py-20 max-w-[1400px] w-full pr-3">
