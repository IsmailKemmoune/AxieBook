...
export default function FeaturScholarCard() {
  return (
    <div className="m-10 bg-primary max-w-[550px] p-6 rounded-lg border-2 border-b-8 border-secondary shadow-card hover:-translate-y-1 transition duration-200 ease-linear">
