...
export default function AxieImage() {
  ...
  console.log(inputId, axieImages);
    ...
    return (
      ...
      >
        ...
        <div className="relative fixed">
          <Image placeholder="blur" loading="eager" blurDataURL="/assets/skeleton.png" width="1280px" height="960px"  loader={axieLoader} src={axie.id} alt={axie.id} quality={100} />
        </div>
      </div>
    );
  });
